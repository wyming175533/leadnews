package com.heima.aliyun.template;
...
import com.heima.aliyun.config.GreenConfigProperties;

import com.heima.aliyun.template.util.ClientUploader;
...
public class GreenImageScan {
    ...
    private GreenConfigProperties properties;

    public GreenImageScan(GreenConfigProperties properties){
        this.properties=properties;
    }

    public Map imageScan(List<byte[]> imageList) throws Exception {
        IClientProfile profile = DefaultProfile
            .getProfile("cn-shanghai", properties.getAccessKeyId(), properties.getSecret());
        DefaultProfile
        ...
        httpBody.put("scenes", Arrays.asList(properties.getScenes().split(",")));
